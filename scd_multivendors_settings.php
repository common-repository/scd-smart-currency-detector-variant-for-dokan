...
function scd_premium_settings_groups($grps) {
    $grps['scd_license_section']=array('id'=>'four','title'=> __('LICENSE INFORMATION', 'scd_dokan_marketplace' ),'callback'=>'scd_options_callback','page'=>'scd_license_options','group'=>'scd_license_options','sanitize'=>'scd_sanitize_license_settings');
...
$fields['scd_license_key'] =array('title'=> __('License Key', 'scd_dokan_marketplace' ),'callback'=>'scd_form_render_license','page'=>'scd_license_options','section'=>'scd_license_section');    
$fields['scd_license_expiry'] =array('title'=> __('License Expiry Date', 'scd_dokan_marketplace' ),'callback'=>'scd_form_render_license_expiry','page'=>'scd_license_options','section'=>'scd_license_section');

$fields['pricesInVendorCurrency'] =array('title'=> __('Display product prices in vendor currency', 'scd_dokan_marketplace' ),'callback'=>'scd_render_pricesInVendorCurrency','page'=>'scd_currency_options','section'=>'scd_currency_section');
