...
// $_regular_price = scd_function_convert_subtotal($_regular_price, get_option('woocommerce_currency'), $user_curr, 2);
if(!get_post_meta($product_id, '_list_regular_price',true)){
	$_regular_price = get_post_meta($product_id, '_regular_price',true);
}else{
	$_regular_price = get_post_meta($product_id, '_list_regular_price',true);
}
if(!get_post_meta($product_id, '_list_sale_price',true)){
	$_sale_price = get_post_meta($product_id, '_sale_price',true);
}else{
	$_sale_price = get_post_meta($product_id, '_list_sale_price',true);
}
// $_sale_price = scd_function_convert_subtotal($_sale_price, get_option('woocommerce_currency'), $user_curr, 2);
